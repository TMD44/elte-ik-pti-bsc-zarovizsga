...
%        \caption{RAID 0}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.28\textwidth]{img/raid1.png}
%        \caption{RAID 1}
        \label{ref:raid1}
    \end{figure}
...
%        \caption{RAID 3}
 ...
 %       \caption{RAID 4}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.45\textwidth]{img/raid5.png}
        \caption{RAID 5}
        \label{ref:raid5}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\textwidth]{img/raid6.png}
        \caption{RAID 6}
        \label{ref:raid6}
    \end{figure}
    ...
    \begin{itemize}[topsep=8pt,itemsep=4pt,partopsep=4pt, parsep=4pt]
        \item A gyakorlatban csak a 0., 1., 5. és 6. szinteket alkalmazzák, illetve az 1+0, 0+1 kombinált megoldásokat. (RAID 2,3,4) nem gyakran használatosak.\\
